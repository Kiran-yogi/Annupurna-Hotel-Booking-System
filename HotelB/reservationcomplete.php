...
<title>Reservation Complete|Annapurna</title>
<meta name="Annapurna Hotel " >
...
<body class="fontbody" >
<div> 
                <h1 style="border: none;text-shadow:2px 2px 12px rgba(69,66,66,0.3);
				padding:0px 20px;	margin:10px; text-align:center;"> 
				 Reservation Completed </h1>
...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<p>
		<i class="icon-phone" style="font-size:24px"></i> <span class="i-name fontgrey">Phone</span><span class="i-code">&emsp; 01-4221711</span><br>
        <i class="icon-fax" style="font-size:24px"></i> <span class="i-name fontgrey">Fax</span><span class="i-code"> &emsp;&emsp;01-4221711</span><br>
        <i class="icon-mail-alt"style="font-size:24px"> </i> <span class="i-name fontgrey">Email</span><span class="i-code">&emsp; info@annapurna.com.np</span>
		</p><hr>
		<div class="row">
			<div class="large-12 columns" >
					...
					<form action="https://www.esewa.com.np/#/home"  target="_top">
					...
					<input type="hidden" name="bn" value="PP-BuyNowBF:btn_buynowCC_LG.gif:NonHostedGuest">
					<img type="image" src="img/esewa.png" style="background-color:white; width:32%; height:14%; padding:2px; " ></img>
					<br><button class="button small " border="0" name="submit" alt="Esewa - The safer, easier way to pay online!" style="width:32%;background-color:#2ecc71; ">Pay Now</button>
					<img alt="" border="0" src="https://www.esewa.com.np" width="1" height="1">
					</form>
